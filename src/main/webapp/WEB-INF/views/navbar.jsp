...
<html>
   ...
   <nav>
    ...
    height: 38px;
    width: 50px;
    position: absolute;margin-left: -56px;" src="images/cartEmpty.png" alt="${cartCount} "/>
    <a href="shoppingCart" style="background: #dc3545; margin-left: -32px;margin-right: 15px;    border-radius: 8px;">${cartCount} </a> 
    ...
    height: 38px;
    width: 50px;
    position: absolute;margin-left: -56px;" src="images/cartFull.png" alt="${cartCount} "/>
    <a href="shoppingCart" style="background: #dc3545; margin-left: -32px;margin-right: 15px;    border-radius: 8px;">${cartCount} </a> 
	<a href="shoppingCart" style="background: #ffc107;     border-radius: 8px;">${cartSum} </a> 
